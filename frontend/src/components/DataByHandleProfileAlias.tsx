...
export default function DataByHandleProfileAlias ( {dataProp} : DataByHP_PropI ) {
    ...
    return(
        ...
        <div className="space-y-3 text-yellow-200 p-4 flex flex-col items-center  " >

            <p className="text-center text-6xl font-semibold mb-10  shadow-lg ">
                {dataProp.handleProfileAlias}
            </p>

            <div className="flex flex-col  w-full max-w-4xl space-y-10  md:space-y-0  md:flex-row md:justify-between md:items-start  " >
                ...
                <div className="p-2 flex gap-5 rounded-lg flex-col items-center   md:items-center md:w-1/2 "> {/*    w-full max-w-lg mx-auto" > */}
                    ...
                    { !isEnabledLinksVoid && enabledLinks.map( 
                        ...
                        (link) => {
                            ...
                            return(
                                ...
                                <div key={link.name} className="items-start flex gap-3 w-[360px] ">
                                    ...
                                    <a 
                                        ...
                                        id={link.name}
                                        className="min-w-[280px] px-2 py-2 flex items-start bg-emerald-600 gap-5 rounded-lg   border-2 border-emerald-700" 
                                        href={link.url}
                                        target="_blank"
                                        rel="noreferrer noopener"
                                    >
                                        
                                        <img src={iconImageDirections} alt="" className="w-12 rounded-full" />
                                        
                                        <p className="text-slate-900 text-lg shadow-lg" >    
